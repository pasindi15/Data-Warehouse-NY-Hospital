-- Run this in SSMS, make sure NYHospitalDW is selected in the dropdown
USE NYHospitalDW;
GO

-- First fix the index issue
IF EXISTS (SELECT * FROM sys.indexes WHERE name = 'UX_DimPayment_Combo')
    DROP INDEX UX_DimPayment_Combo ON dbo.DimPayment;
GO

-- Now insert into FactAdmission using cross-database query
